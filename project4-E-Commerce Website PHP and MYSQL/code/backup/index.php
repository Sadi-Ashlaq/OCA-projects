                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo"><a href="index.php"><img src="./images/icon/logo.gif"
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-left text-left">
                            <div class="img-part">
                                <img src="./images/game/banner/1.jpg" class="img-fluid bg-img blur-up lazyload"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="./images/game/banner/2.jpg" class="img-fluid bg-img blur-up lazyload"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current">
                                <a href="tab-4.php">New Products</a>
                            </li>
                            <li class="">
                                <a href="tab-5.php">Featured Products</a>
                            </li>
                            <li class="">
                                <a href="tab-6.php">Best Sellers</a>
                            </li>
                        </ul>
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="cart-info cart-wrap">
                                                ...
                                                <a href="compare.php" title="Compare"><i class="ti-reload"
                                                        aria-hidden="true"></i></a>
                                            </div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            ...
                            <div>
                                ...
                                <div class="media">
                                    <!-- Item image -->
                                    <a href="product-page(no-sidebar).php"><img class="img-fluid blur-up lazyload"
                                            src="..." alt=""></a>
                                    <div class="media-body align-self-center">
                                        ...
                                        <h4><!-- Item new price --> <del><!-- Item old price --></del></h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <!-- Item image -->
            ...
            <div class="row">
                <div class="col">
                    <div class="product-slider-5 product-m no-arrow">
                        ...
                        <div class="media"> <!-- Change it to product-box -->
                            <div class="img-wrapper">
                                <div class="front">
                                    <!-- Item image -->
                                    <a href="product-page(no-sidebar).php"><img src="..."
                                            class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
