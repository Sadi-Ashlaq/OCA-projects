...
class SupplierController extends Controller
{
    ...
    public function handCraftProfile($id)
    {
        $suplier    =    Supplier::where('category_id', $id)->get()->first();

        // $suplier    =   new Supplier();

        // $proimage =        Product::where('supplier_id',  $suplier->$id)->get();
        $proimage =        Product::where('supplier_id',  $suplier->id)->get();
        // $proimage = new Category;
        // dd($suplier->products()->$id);


        // dd($proimage);

        // $proimage =    Product::where('id', $id)->get();
        // $proimage = $prosup->products;
        // $proname   =   $proimage->proimage;
        // dd($suplier);


        return view('supplier_profile', compact('suplier', 'proimage'));
    }
    ...
    public function shopProduct($id)
    {
        ...
        $catname   =   $productcat->category->cat_name;
