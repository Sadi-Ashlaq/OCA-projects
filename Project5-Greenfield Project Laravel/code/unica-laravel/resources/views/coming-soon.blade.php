...
<!-- Mirrored from htmldemo.hasthemes.com/learts/learts/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Dec 2020 21:45:15 GMT -->
<!-- Added by HTTrack -->
...
<body>
    ...
    <div class="coming-soon-section section section-padding"
        data-bg-image="{{ asset('unica/assets/images/bg/coming-soon-bg.jpg') }}">
        <div class="container">
            <div class="coming-soon-content">
                <div class="logo">
                    <a href="{{ route('index') }}"><img src="{{ asset('unica/assets/images/logo/logo-2.png') }}" alt=""></a>
                </div>
                <h2 class="title">Coming soon</h2>
                <div class="countdown3" data-countdown="2021/01/01"></div>
