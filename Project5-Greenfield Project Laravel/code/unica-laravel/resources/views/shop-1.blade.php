            ...
            <div class="container-fluid">
                <div class="row row-cols-lg-5 row-cols-md-3 row-cols-sm-2 row-cols-1 learts-mb-n30">
                    ...
                    <div class="col learts-mb-30">
                        ...
                        <ul class="widget-list product-filter-widget customScroll">
                            <li> <a href="#">All</a></li>
                            <li> <a href="#"><span class="amount"><span class="cur-symbol">£</span>0.00</span> - <span
                                        class="amount"><span class="cur-symbol">£</span>80.00</span></a></li>
                            <li> <a href="#"><span class="amount"><span class="cur-symbol">£</span>80.00</span> - <span
                                        class="amount"><span class="cur-symbol">£</span>160.00</span></a></li>
                            <li> <a href="#"><span class="amount"><span class="cur-symbol">£</span>160.00</span> - <span
                                        class="amount"><span class="cur-symbol">£</span>240.00</span></a></li>
                            <li> <a href="#"><span class="amount"><span class="cur-symbol">£</span>240.00</span> - <span
                                        class="amount"><span class="cur-symbol">£</span>320.00</span></a></li>
                        ...
                        <div id="shop-products"
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-17.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-17-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">3D Attractive Pot</a></h6>
                                        <span class="price">
                                            $90.00
                                        </span>
                                        <div class="product-buttons">
                                            <a href="#quickViewModal" data-toggle="modal" class="product-button hintT-top"
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            ...
                                            <img src="{{ asset('unica/assets/images/product/s328/product-14.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-14-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Abstract Folded Pots</a></h6>
                                        <span class="price">
                                            $50.00 - $55.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col featured">
                                <div class="product">
                                    <div class="product-thumb">
                                        ...
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-30.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-30-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Adhesive Tape Dispenser</a></h6>
                                        <span class="price">
                                            $15.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col featured">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-9.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-9-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Aluminum Equestrian</a></h6>
                                        <span class="price">
                                            $100.00
                                        </span>
                                        <div class="product-buttons">
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            ...
                                            <img src="{{ asset('unica/assets/images/product/s328/product-25.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-25-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Antique Sewing Scissors</a></h6>
                                        <span class="price">
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            ...
                                            <img src="{{ asset('unica/assets/images/product/s328/product-1.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-1-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Boho Beard Mug</a></h6>
                                        <span class="price">
                            ...
                            <div class="grid-item col new">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-31.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Bouncer Measuring Cup</a></h6>
                                        <span class="price">
                                            $150.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col new">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-15.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-15-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Brush & Dustpan Set</a></h6>
                                        <span class="price">
                                            $9.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col featured">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-12.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-12-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Cape Cottage Playhouse</a></h6>
                                        <span class="price">
                                            $35.00
                                        </span>
                                        <div class="product-buttons">
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            ...
                                            <img src="{{ asset('unica/assets/images/product/s328/product-32.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-32-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Cleaning Dustpan & Brush</a></h6>
                                        <span class="price">
                                            $38.00 - $50.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col featured">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-6.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-6-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Clear Silicate Teapot</a></h6>
                                        <span class="price">
                                            $140.00
                                        </span>
                                        <div class="product-buttons">
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            ...
                                            <img src="{{ asset('unica/assets/images/product/s328/product-19.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Country Feast Set</a></h6>
                                        <span class="price">
                                            <span class="old">$45.00</span>
                                            <span class="new">$39.00</span>
                                        </span>
                                ...
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            ...
                                            <img src="{{ asset('unica/assets/images/product/s328/product-8.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-8-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Decorative Christmas Fox</a></h6>
                                        <span class="price">
                                            $50.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col featured">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-28.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-28-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Digital Camera System</a></h6>
                                        <span class="price">
                                            $350.00
                                        </span>
                                        <div class="product-buttons">
                            ...
                            <div class="grid-item col new">
                                <div class="product">
                                    <div class="product-thumb">
                                        <a href="{{ route('product-details') }}" class="image">
                                            <img src="{{ asset('unica/assets/images/product/s328/product-11.jpg') }}"
                                                alt="Product Image">
                                            <img class="image-hover "
                                                src="{{ asset('unica/assets/images/product/s328/product-11-hover.jpg') }}"
                                                alt="Product Image">
                                        </a>
                                        <a href="wishlist.html" class="add-to-wishlist hintT-left"
                                            data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                    ...
                                    <div class="product-info">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Electric Egg Blender</a></h6>
                                        <span class="price">
                                            $200.00
                                        </span>
                                        <div class="product-buttons">
                        ...
                        <div class="single-widget learts-mb-40">
                            ...
                            <ul class="widget-products">
                                <li class="product">
                                    <div class="thumbnail">
                                        <a href="{{ route('product-details') }}"><img
                                                src="{{ asset('unica/assets/images/product/widget-1.jpg') }}"
                                                alt="List product"></a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Walnut Cutting Board</a></h6>
                                        <span class="price">
                                            $100.00
                                        </span>
                                        <div class="ratting">
                                ...
                                <li class="product">
                                    <div class="thumbnail">
                                        <a href="{{ route('product-details') }}"><img
                                                src="{{ asset('unica/assets/images/product/widget-2.jpg') }}"
                                                alt="List product"></a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Decorative Christmas Fox</a></h6>
                                ...
                                <li class="product">
                                    <div class="thumbnail">
                                        <a href="{{ route('product-details') }}"><img
                                                src="{{ asset('unica/assets/images/product/widget-3.jpg') }}"
                                                alt="List product"></a>
                                    </div>
                                    <div class="content">
                                        <h6 class="title"><a href="{{ route('product-details') }}">Lucky Wooden Elephant</a></h6>
                                        <span class="price">
                                            $35.00
                                        </span>
                                    </div>
